      ...
      <div className="wc-match-row__teams">
        <Space size={6} style={{ flex: 1, justifyContent: 'flex-end' }}>
          ...
          {getTeamFlagUrl(match.homeTeam) ? (
            <img src={getTeamFlagUrl(match.homeTeam)} alt="" style={{ width: 20, height: 14, objectFit: 'cover', borderRadius: 2 }} />
          ) : (
        ...
        <Space size={6} style={{ flex: 1 }}>
          {getTeamFlagUrl(match.awayTeam) ? (
            <img src={getTeamFlagUrl(match.awayTeam)} alt="" style={{ width: 20, height: 14, objectFit: 'cover', borderRadius: 2 }} />
          ) : (
